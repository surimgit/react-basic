...
export default function StateComponent() {
  ...
  // const [ 상태변수, 상태변경함수 ] = useState<상태변수의 타입>(초기값);
  ...
  const onChagneHandler = (event: ChangeEvent<HTMLInputElement>) => {
  ...
  return (
    <div>
      ...
      <p>{comment}</p>
      <input value={comment} onChange={onChagneHandler} />

      <div style={{margin: '40px', border: '1px solid gray', padding: '40px'}}>
        <input value={comment} onChange={onChagneHandler} onKeyDown={onKeyDownHandler}/>
