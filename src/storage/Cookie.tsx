...
// document.cookie로 쿠키 값을 지정할 수 있음
// 예) document.cookie = "cookieName=쿠키연습; path=/"

// 기본 document를 이용한 cookie 작업은 매우 불편함
// react에선 react-cookie라는 패키지를 이용하여 조금 더 수월하게 cookie를 다룰 수 있게 됨
...
export default function Cookie() {
  ...
  // useCookies: react에서 쿠키 객체, 쿠키 변경 함수, 쿠키 제거 함수를 배열로 반환하는
  //             react cookie의 훅 함수 
  const [cookies, setCookie, removeCookie] = useCookies();
  
  const onAddClick = () => {
    // 쿠키를 추가할 때 setCookie 함수를 사용할 수 있음
    // - setCookie(쿠키이름, 쿠키값, 옵션)
